...
<div align="center">
  ...
  <a href="https://ci.obydux.win/job/Nautilus/job/1.21.11/" class="badge-link" target="_blank" rel="noopener noreferrer">
    <img src="https://img.shields.io/jenkins/build?jobUrl=https://ci.obydux.win/job/Nautilus/job/1.21.11/" alt="Jenkins Build" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
  </a>
...
## API
You can find the javadocs [here](https://repo.obydux.win/javadoc/snapshots/win/obydux/nautilus/nautilus-api/1.21.11-R0.1-SNAPSHOT).
...
dependencies {
    compileOnly 'win.obydux.nautilus:nautilus-api:1.21.11-R0.1-SNAPSHOT'
}
```
