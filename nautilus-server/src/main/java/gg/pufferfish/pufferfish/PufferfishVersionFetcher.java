...
public class PufferfishVersionFetcher implements VersionFetcher {
    ...
    // Nautilus start
    private static final URI JENKINS_URI = URI.create("https://ci.obydux.win/job/Nautilus/job/1.21.8/lastSuccessfulBuild/buildNumber");
    private static final String GITHUB_FORMAT = "https://api.github.com/repos/Obydux/Nautilus/compare/ver/1.21.8...%s";
    // Nautilus end
    ...
    private @NotNull Component getResponseMessage(final int versionDiff) {
        return switch (Math.max(-1, Math.min(1, versionDiff))) {
            case -1 -> text("You are running an unsupported version of Nautilus.", RED); // Nautilus
